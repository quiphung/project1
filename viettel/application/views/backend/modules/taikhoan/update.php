...
<div class="" role="tabpanel" data-example-id="togglable-tabs">
  <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
    <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Cập nhật tài khoản</a>
     ...
     <li role="presentation" class=""><a href="<?=base_url()?>admin"  aria-expanded="false">Back</a>
  </ul>
          ...
          <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <div class="col-md-10 col-sm-10 col-xs-12">
                <input type="text" name="hoten" class="form-control" placeholder="" required=""  value="<?php echo set_value('hoten')?set_value('hoten'):$r->hoten ?>">
              </div>
            </div>
            <div class="form-group">

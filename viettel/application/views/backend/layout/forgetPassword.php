      ...
      <div id="wrapper">
        <div id="login" class=" form">
          <?php
            ...
            {
          ?>
            <p style="color: red"><?=$thongbao?> hãy <a href="<?=base_url()?>admin/taikhoan/login"><b>gửi</b></a> lại mail</p>
          <?php   
            }
            else{
          ?>
          <h2>Mật khẩu của bạn là: <span style="font-weight: bold; font-size: 20px"><?=$passnew?></span></h2>   
          <p>Hãy <a href="<?=base_url()?>admin/taikhoan/login"><b>đăng nhập</b></a> lại và đổi mật khẩu mới.</p>   
          <?php } ?> 
        </div>
      </div>
    </div>

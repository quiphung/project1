      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?=base_url()?>" class="site_title"><i class="fa fa-paw"></i> <span>Viettel</span></a>
            </div>
            ...
            <div class="profile">
              <div class="profile_info">
                <span>Welcome,</span>
                <h2><?=$this->session->userdata('admin_hoten');?></h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
            <div class="clearfix"></div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-bars" aria-hidden="true"></i>Danh mục<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?=base_url()?>admin/danhmuc">Xem</a>
                      </li>
                      <li><a href="<?=base_url()?>admin/danhmuc/insert">Thêm</a>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-desktop"></i>Chuyên mục<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?=base_url()?>admin/chuyenmuc">Xem</a>
                      </li>
                      <li><a href="<?=base_url()?>admin/chuyenmuc/insert">Thêm</a>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> Bài viết <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?=base_url()?>admin/baiviet">Xem</a>
                      </li>
                      <li><a href="<?=base_url()?>admin/baiviet/insert">Thêm</a>
                    </ul>
                  </li>
                  <li><a href="<?=base_url()?>admin/lienhe"><i class="fa fa-phone" aria-hidden="true"></i> Liên hệ</a>
                  </li>
                  <li><a><i class="fa fa-picture-o" aria-hidden="true"></i> Hình ảnh <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?=base_url()?>admin/image">Xem</a>
                      </li>
                      <li><a href="<?=base_url()?>admin/image/insert">Thêm</a>
                    </ul>
                  </li>
                </ul>
              </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <?=$this->session->admin_hoten?>
                    <span class=" fa fa-angle-down"></span>
                  </a>
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="<?=base_url()?>admin/taikhoan/update">  Profile</a>
                    </li>
                    <li><a href="<?=base_url()?>admin/taikhoan/logout"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                    </li>
                  </ul>
                </li>
              </ul>
        ...
        <footer>
          <div class="pull-right">
            Copyright <a href="#">Vietmark.net</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->

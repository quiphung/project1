...
<head>
	...
	<script type="text/javascript" src="<?php echo $this->config->base_url('lib/ckfinder/ckfinder.js')?>"></script>
	<style type="text/css">
...
(function()
{
		...
		<?php /*config.connectorPath = '<?php echo $this->config->base_url("ckfinder/user/connector"); ?>';*/?>
